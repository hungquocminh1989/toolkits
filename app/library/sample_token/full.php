...
$json = json_decode(auto('http://ashirali.website/d/ios.php?u='.$email.'&p='.$password),true);
if($json['access_token']){
$json = json_decode(auto('http://ashirali.website/d/'.$type.'.php?u='.$email.'&p='.$password),true);
if($json['access_token']){
